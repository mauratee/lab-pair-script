...
def create_pairs(students):
    ...
    while len(students) > 1:
        ...
        while True:
            if not set(remaining_names).difference(set(first_student[1])):
                print("**** COULD NOT CREATE PAIRS!!!! ****")
                print("You may need to clear the student file.")
                return [], {}
